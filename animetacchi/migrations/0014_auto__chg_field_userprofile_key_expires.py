...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'animetacchi_userprofile', 'key_expires', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.key_expires'
        db.alter_column(u'animetacchi_userprofile', 'key_expires', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'animetacchi.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
