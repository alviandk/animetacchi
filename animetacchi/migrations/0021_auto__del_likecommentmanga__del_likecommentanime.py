...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'LikeCommentManga'
        db.delete_table(u'animetacchi_likecommentmanga')

        # Deleting model 'LikeCommentAnime'
        db.delete_table(u'animetacchi_likecommentanime')


    def backwards(self, orm):
        # Adding model 'LikeCommentManga'
        db.create_table(u'animetacchi_likecommentmanga', (
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.CommentManga'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Members'], null=True, blank=True)),
        ))
        db.send_create_signal(u'animetacchi', ['LikeCommentManga'])

        # Adding model 'LikeCommentAnime'
        db.create_table(u'animetacchi_likecommentanime', (
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.CommentAnime'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Members'], null=True, blank=True)),
        ))
        db.send_create_signal(u'animetacchi', ['LikeCommentAnime'])
