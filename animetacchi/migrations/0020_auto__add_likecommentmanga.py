...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'animetacchi.likecommentmanga': {
            'Meta': {'object_name': 'LikeCommentManga'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['animetacchi.CommentManga']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['animetacchi.Members']", 'null': 'True', 'blank': 'True'})
        },
        u'animetacchi.manga': {
