...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RequestAnime'
        db.create_table(u'animetacchi_requestanime', (
        ...
        db.send_create_signal(u'animetacchi', ['RequestAnime'])


    def backwards(self, orm):
        # Deleting model 'RequestAnime'
        db.delete_table(u'animetacchi_requestanime')
