...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field character_manga on 'Daikirailist'
        m2m_table_name = db.shorten_name(u'animetacchi_daikirailist_character_manga')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('daikirailist', models.ForeignKey(orm[u'animetacchi.daikirailist'], null=False)),
            ('charactermanga', models.ForeignKey(orm[u'animetacchi.charactermanga'], null=False))
        ))
        db.create_unique(m2m_table_name, ['daikirailist_id', 'charactermanga_id'])

        # Adding M2M table for field character_manga on 'Daisukilist'
        m2m_table_name = db.shorten_name(u'animetacchi_daisukilist_character_manga')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('daisukilist', models.ForeignKey(orm[u'animetacchi.daisukilist'], null=False)),
            ('charactermanga', models.ForeignKey(orm[u'animetacchi.charactermanga'], null=False))
        ))
        db.create_unique(m2m_table_name, ['daisukilist_id', 'charactermanga_id'])


    def backwards(self, orm):
        # Removing M2M table for field character_manga on 'Daikirailist'
        db.delete_table(db.shorten_name(u'animetacchi_daikirailist_character_manga'))

        # Removing M2M table for field character_manga on 'Daisukilist'
        db.delete_table(db.shorten_name(u'animetacchi_daisukilist_character_manga'))
    ...
    models = {
        ...
        u'animetacchi.commentanime': {
            'Meta': {'ordering': "['-edited', '-added']", 'object_name': 'CommentAnime'},
        ...
        u'animetacchi.commentmanga': {
            'Meta': {'ordering': "['-edited', '-added']", 'object_name': 'CommentManga'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'animetacchi.daikirailist': {
            ...
            'character_manga': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['animetacchi.CharacterManga']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
