...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CommentManga.anime'
        db.delete_column(u'animetacchi_commentmanga', 'anime_id')

        # Adding field 'CommentManga.manga'
        db.add_column(u'animetacchi_commentmanga', 'manga',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Manga'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CommentManga.anime'
        db.add_column(u'animetacchi_commentmanga', 'anime',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Manga'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CommentManga.manga'
        db.delete_column(u'animetacchi_commentmanga', 'manga_id')
