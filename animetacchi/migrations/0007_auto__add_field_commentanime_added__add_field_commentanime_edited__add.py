...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommentAnime.added'
        db.add_column(u'animetacchi_commentanime', 'added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CommentAnime.edited'
        db.add_column(u'animetacchi_commentanime', 'edited',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Character.picture'
        db.add_column(u'animetacchi_character', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoiceActor.picture'
        db.add_column(u'animetacchi_voiceactor', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommentAnime.added'
        db.delete_column(u'animetacchi_commentanime', 'added')

        # Deleting field 'CommentAnime.edited'
        db.delete_column(u'animetacchi_commentanime', 'edited')

        # Deleting field 'Character.picture'
        db.delete_column(u'animetacchi_character', 'picture')

        # Deleting field 'VoiceActor.picture'
        db.delete_column(u'animetacchi_voiceactor', 'picture')
