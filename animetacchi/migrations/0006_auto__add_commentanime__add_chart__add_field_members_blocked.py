...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentAnime'
        db.create_table(u'animetacchi_commentanime', (
            ...
            ('anime', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Anime'], null=True, blank=True)),
        ))
        db.send_create_signal(u'animetacchi', ['CommentAnime'])

        # Adding model 'Chart'
        db.create_table(u'animetacchi_chart', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('season', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'animetacchi', ['Chart'])

        # Adding M2M table for field anime on 'Chart'
        m2m_table_name = db.shorten_name(u'animetacchi_chart_anime')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('chart', models.ForeignKey(orm[u'animetacchi.chart'], null=False)),
            ('anime', models.ForeignKey(orm[u'animetacchi.anime'], null=False))
        ))
        db.create_unique(m2m_table_name, ['chart_id', 'anime_id'])

        # Adding field 'Members.blocked'
        db.add_column(u'animetacchi_members', 'blocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CommentAnime'
        db.delete_table(u'animetacchi_commentanime')

        # Deleting model 'Chart'
        db.delete_table(u'animetacchi_chart')

        # Removing M2M table for field anime on 'Chart'
        db.delete_table(db.shorten_name(u'animetacchi_chart_anime'))

        # Deleting field 'Members.blocked'
        db.delete_column(u'animetacchi_members', 'blocked')
