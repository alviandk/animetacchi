...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CharacterManga.anime'
        db.delete_column(u'animetacchi_charactermanga', 'anime_id')

        # Adding field 'CharacterManga.manga'
        db.add_column(u'animetacchi_charactermanga', 'manga',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Manga'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CharacterManga.anime'
        db.add_column(u'animetacchi_charactermanga', 'anime',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Manga'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CharacterManga.manga'
        db.delete_column(u'animetacchi_charactermanga', 'manga_id')
