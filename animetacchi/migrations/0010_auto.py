...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field voice_character on 'Daisukilist'
        m2m_table_name = db.shorten_name(u'animetacchi_daisukilist_voice_character')
        ...
        db.create_unique(m2m_table_name, ['daisukilist_id', 'voicecharacter_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field voice_character on 'Daisukilist'
        db.delete_table(db.shorten_name(u'animetacchi_daisukilist_voice_character'))
