...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Members.user'
        db.alter_column(u'animetacchi_members', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'Members', fields ['user']
        db.create_unique(u'animetacchi_members', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Members', fields ['user']
        db.delete_unique(u'animetacchi_members', ['user_id'])


        # Changing field 'Members.user'
        db.alter_column(u'animetacchi_members', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'animetacchi.members': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'members'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'animetacchi.news': {
        ...
        u'animetacchi.requestanime': {
            'Meta': {'ordering': "['-added']", 'object_name': 'RequestAnime'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'anime': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['animetacchi.Anime']", 'null': 'True', 'blank': 'True'}),
