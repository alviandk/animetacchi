...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Daisukilist'
        db.create_table(u'animetacchi_daisukilist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('members', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animetacchi.Members'])),
        ))
        db.send_create_signal(u'animetacchi', ['Daisukilist'])

        # Adding M2M table for field anime on 'Daisukilist'
        m2m_table_name = db.shorten_name(u'animetacchi_daisukilist_anime')
        ...
        db.create_unique(m2m_table_name, ['daisukilist_id', 'anime_id'])

        # Adding M2M table for field character on 'Daisukilist'
        m2m_table_name = db.shorten_name(u'animetacchi_daisukilist_character')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('daisukilist', models.ForeignKey(orm[u'animetacchi.daisukilist'], null=False)),
            ('character', models.ForeignKey(orm[u'animetacchi.character'], null=False))
        ))
        db.create_unique(m2m_table_name, ['daisukilist_id', 'character_id'])

        # Adding M2M table for field voice_actor on 'Daisukilist'
        m2m_table_name = db.shorten_name(u'animetacchi_daisukilist_voice_actor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('daisukilist', models.ForeignKey(orm[u'animetacchi.daisukilist'], null=False)),
            ('voiceactor', models.ForeignKey(orm[u'animetacchi.voiceactor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['daisukilist_id', 'voiceactor_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Daisukilist'
        db.delete_table(u'animetacchi_daisukilist')

        # Removing M2M table for field anime on 'Daisukilist'
        db.delete_table(db.shorten_name(u'animetacchi_daisukilist_anime'))

        # Removing M2M table for field character on 'Daisukilist'
        db.delete_table(db.shorten_name(u'animetacchi_daisukilist_character'))

        # Removing M2M table for field voice_actor on 'Daisukilist'
        db.delete_table(db.shorten_name(u'animetacchi_daisukilist_voice_actor'))
